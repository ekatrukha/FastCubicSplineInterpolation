...
public class CubicSplineImageJ {
	private double[] y2;
	...
	public CubicSplineImageJ(int[] x, int[] y, int n) {
		initSpline(x, y, n);
	}
	 ...
	 *	ends */
	public CubicSplineImageJ(float[] x, float[] y, int n, boolean closed) {
		initSpline(x, y, n, closed);
	}

	public CubicSplineImageJ(float[] x, float[] y, int n) {
